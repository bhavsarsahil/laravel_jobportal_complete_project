                        ...
                        <div class="card border-0 shadow mb-4 ">
                            <div class="card-body card-form p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control summernote" name="description" id="description" cols="5" rows="5"
                                        placeholder="Description">{{ $job->description }}</textarea>
                                    <p></p>
                                </div>
                                <div class="mb-4">
                                    <label for="" class="mb-2">Benefits</label>
                                    <textarea class="form-control summernote" name="benefits" id="benefits" cols="5" rows="5"
