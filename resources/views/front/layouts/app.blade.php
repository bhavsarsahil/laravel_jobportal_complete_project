...
<head>
    ...
    <link rel="shortcut icon" type="x-icon" href="{{ asset('assets/image/job-offer.png') }}">
...
<main class="flex-grow-1">
        ...
        <footer class="bg-dark py-3 bg-2">
            <div class="container">
                <p class="text-center text-white pt-3 fw-bold fs-6">© 2024 CareerVibe company, all right reserved</p>
            </div>
        </footer>
